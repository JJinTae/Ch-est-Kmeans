...
namespace HybridizerSample1 { 
struct QPSK_Kmeans___c__DisplayClass0_0 ;
} // Leaving namespace
namespace HybridizerSample1 { 
struct QPSK_Kmeans ;
} // Leaving namespace
...
{
	if (strcmp (fullTypeName, "HybridizerSample1.Program") == 0) return 1000000 ; 
	if (strcmp (fullTypeName, "HybridizerSample1.Program+<>c__DisplayClass0_0") == 0) return 1000001 ; 
	if (strcmp (fullTypeName, "HybridizerSample1.QPSK_Kmeans") == 0) return 1000002 ; 
	if (strcmp (fullTypeName, "HybridizerSample1.QPSK_Kmeans+<>c__DisplayClass0_0") == 0) return 1000003 ; 
	...
	if (strcmp (fullTypeName, "System.Numerics.Complex") == 0) return 1000006 ; 
	if (strcmp (fullTypeName, "System.Object") == 0) return 1000007 ; 
	if (strcmp (fullTypeName, "System.Threading.Tasks.Parallel") == 0) return 1000008 ; 
	if (strcmp (fullTypeName, "System.Threading.Tasks.ParallelLoopResult") == 0) return 1000009 ; 
	return 0 ;
}
extern "C" DLL_PUBLIC const char* HybridizerGetTypeFromID( const int typeId)
{
	if (typeId == 1000000) return "HybridizerSample1.Program" ; 
	if (typeId == 1000001) return "HybridizerSample1.Program+<>c__DisplayClass0_0" ; 
	if (typeId == 1000002) return "HybridizerSample1.QPSK_Kmeans" ; 
	if (typeId == 1000003) return "HybridizerSample1.QPSK_Kmeans+<>c__DisplayClass0_0" ; 
	if (typeId == 1000004) return "System.Action<System.Int32>" ; 
	if (typeId == 1000005) return "System.Nullable<System.Int64>" ; 
	if (typeId == 1000006) return "System.Numerics.Complex" ; 
	if (typeId == 1000007) return "System.Object" ; 
	if (typeId == 1000008) return "System.Threading.Tasks.Parallel" ; 
	if (typeId == 1000009) return "System.Threading.Tasks.ParallelLoopResult" ; 
	return "" ;
}
extern "C" DLL_PUBLIC int HybridizerGetShallowSize (const char* fullTypeName) 
{
	#ifdef __TYPE_DECL__HybridizerSample1_Program___
	if (strcmp (fullTypeName, "HybridizerSample1.Program") == 0) return 8 ; 
	#endif
	#ifdef __TYPE_DECL__HybridizerSample1_Program___c__DisplayClass0_0__
	if (strcmp (fullTypeName, "HybridizerSample1.Program+<>c__DisplayClass0_0") == 0) return 24 ; 
	#endif
	#ifdef __TYPE_DECL__HybridizerSample1_QPSK_Kmeans___
	if (strcmp (fullTypeName, "HybridizerSample1.QPSK_Kmeans") == 0) return 48 ; 
	#endif
	#ifdef __TYPE_DECL__HybridizerSample1_QPSK_Kmeans___c__DisplayClass0_0__
	if (strcmp (fullTypeName, "HybridizerSample1.QPSK_Kmeans+<>c__DisplayClass0_0") == 0) return 40 ; 
	#endif
	...
	#endif
	#ifdef __TYPE_DECL__System_Numerics_Complex__
	if (strcmp (fullTypeName, "System.Numerics.Complex") == 0) return 16 ; 
	#endif
...
extern "C" DLL_PUBLIC int HybridizerSample1x46Programx46Run_OccupancyCalculator_MaxActiveBlocksPerSM(int* numBlocks, int blockSize, int sharedMemSize) 
{
    ...
    cures = cuModuleGetFunction(&__hybridizer__cufunc, __hybridizer__gs_module.module, "HybridizerSample1x46Programx46Run");
    if (cures != CUDA_SUCCESS) return hybridizer::translateCUresult((int)cures);
    
    return cuOccupancyMaxActiveBlocksPerMultiprocessor(numBlocks, __hybridizer__cufunc, blockSize, sharedMemSize);
}

extern "C" DLL_PUBLIC int HybridizerSample1x46Programx46Run_ExternCWrapper_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  int N,  int* const a,  int* const b)
{
	if (0 == __hybridizer_initialized) {                                                            
		cudaDeviceSynchronize();                                                                       
		__hybridizer_initialized = 1;                                                                  
...
extern "C" DLL_PUBLIC int HybridizerSample1x46Programx46Run_ExternCWrapperStream_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  cudaStream_t st,  int N,  int* const a,  int* const b)
{
	if (0 == __hybridizer_initialized) {                                                            
		cudaDeviceSynchronize();                                                                       
		__hybridizer_initialized = 1;                                                                  
...
#if CUDART_VERSION >= 9000
extern "C" DLL_PUBLIC int HybridizerSample1x46Programx46Run_ExternCWrapperGridSync_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  int N,  int* const a,  int* const b)
{
	if (0 == __hybridizer_initialized) {                                                            
		cudaDeviceSynchronize();                                                                       
		__hybridizer_initialized = 1;                                                                  
...
#if CUDART_VERSION >= 9000
extern "C" DLL_PUBLIC int HybridizerSample1x46Programx46Run_ExternCWrapperStreamGridSync_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  cudaStream_t st,  int N,  int* const a,  int* const b)
{
	if (0 == __hybridizer_initialized) {                                                            
		cudaDeviceSynchronize();                                                                       
		__hybridizer_initialized = 1;                                                                  
...
extern "C" DLL_PUBLIC int HybridizerSample1x46QPSK_Kmeansx46Run_OccupancyCalculator_MaxActiveBlocksPerSM(int* numBlocks, int blockSize, int sharedMemSize) 
{
    if (0 == __hybridizer_initialized)
    {
        cudaDeviceSynchronize();
    ...
    cures = cuModuleGetFunction(&__hybridizer__cufunc, __hybridizer__gs_module.module, "HybridizerSample1x46QPSK_Kmeansx46Run");
    if (cures != CUDA_SUCCESS) return hybridizer::translateCUresult((int)cures);
    
    return cuOccupancyMaxActiveBlocksPerMultiprocessor(numBlocks, __hybridizer__cufunc, blockSize, sharedMemSize);
}

extern "C" DLL_PUBLIC int HybridizerSample1x46QPSK_Kmeansx46Run_ExternCWrapper_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  int N,  double* const c,  System::Numerics::Complex* const y,  double center0,  double center1)
{
	if (0 == __hybridizer_initialized) {                                                            
		cudaDeviceSynchronize();                                                                       
		__hybridizer_initialized = 1;                                                                  
...
extern "C" DLL_PUBLIC int HybridizerSample1x46QPSK_Kmeansx46Run_ExternCWrapperStream_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  cudaStream_t st,  int N,  double* const c,  System::Numerics::Complex* const y,  double center0,  double center1)
{
	if (0 == __hybridizer_initialized) {                                                            
		cudaDeviceSynchronize();                                                                       
		__hybridizer_initialized = 1;                                                                  
...
#if CUDART_VERSION >= 9000
extern "C" DLL_PUBLIC int HybridizerSample1x46QPSK_Kmeansx46Run_ExternCWrapperGridSync_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  int N,  double* const c,  System::Numerics::Complex* const y,  double center0,  double center1)
{
	if (0 == __hybridizer_initialized) {                                                            
		cudaDeviceSynchronize();                                                                       
		__hybridizer_initialized = 1;                                                                  
...
#if CUDART_VERSION >= 9000
extern "C" DLL_PUBLIC int HybridizerSample1x46QPSK_Kmeansx46Run_ExternCWrapperStreamGridSync_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  cudaStream_t st,  int N,  double* const c,  System::Numerics::Complex* const y,  double center0,  double center1)
{
	if (0 == __hybridizer_initialized) {                                                            
		cudaDeviceSynchronize();                                                                       
		__hybridizer_initialized = 1;                                                                  
